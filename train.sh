...
# train
~/miniconda2/bin/python train.py -model_type img -data data/im2text/hw -save_model im2text-hw-model -gpuid 0 -batch_size 20 -max_grad_norm 20 -optim adam -learning_rate 0.001 -epochs 20
